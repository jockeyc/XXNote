...
public class RecentFragment extends BaseFragment implements CardStackView.ItemExpendListener{
    ...
    private void initBmob() {
        ...
        innerquery.addWhereEqualTo("users",users);
        query.addWhereMatchesQuery("book","Notebook",innerquery);
    ...
    private void initView(View rootView) {
        cardStackView = (CardStackView)rootView.findViewById(R.id.card_stack_recent);
